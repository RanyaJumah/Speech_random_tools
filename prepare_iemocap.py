...
def load_utterInfo(inputFile):
    pattern = re.compile(
        ...
        re.IGNORECASE)
    with open(inputFile, 'r', errors='ignore') as myfile:
...
if __name__ == '__main__':
    ROOT_PATH = os.getcwd()
    AUDIO_DIR = '/Volumes/NO NAME/Dataset/IEMOCAP_full_release/Session'
    MOD_AUDIO_DIR = '/Users/RanyaJo/Desktop/test_experiment/dataset/IEMOCAP_ahsn_leave-two-speaker-out'
    LOG_NAME = 'IEMOCAP'
